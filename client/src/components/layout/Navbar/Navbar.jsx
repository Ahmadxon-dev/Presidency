...
const LinkWithRef = React.forwardRef(({ to, ...props }, ref) => <RouterLink ref={ref} to={to} {...props} />)
...
const Navbar = () => {
    ...
    const navItems = useMemo(() => {
        return [
            ...
            if (el.adminOnly && user?.role !== "admin") return false
            if (el.admin1 === true && user?.login !== "admin1") return false
            if (el.studentOnly && user?.role !== "student") return false
            if (el.classOnly && user?.role !== "class") return false
            return true
        })
    }, [user])
                    ...
                    <div className="flex items-center space-x-8">
                        ...
                        <RouterLink to="/">
                            <div className="flex items-center space-x-2 group cursor-pointer">
                                ...
                                <span className="text-xl font-bold text-foreground tracking-tight hover:text-accent-foreground">Presidency</span>
                            </div>
                        </RouterLink>
                        ...
                        <div className="hidden lg:block">
                            <DropdownMenu>
                                ...
                                >
                                    <DropdownMenuItem
                                        onClick={goProfile}
                                        className="flex items-center space-x-2 cursor-pointer hover:bg-muted/50 transition-colors duration-200"
                                    >
